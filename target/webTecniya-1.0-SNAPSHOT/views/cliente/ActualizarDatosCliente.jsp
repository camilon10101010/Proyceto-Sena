...
<body>
  ...
  <section class="form-register">
         <form action="../../ControllerCliente" class="form" method="POST">
            ...
            <h4>Estas Actualizando: <%out.println(consultaCliente.get(0).getNombreCliente()); %></h4>
                <div>
    ...
    <div>
       <select class="select-css"  name="tipoDocumento">
        ...
        <label>Nombre *</label>
    <div>
      <input value="" class="controls" type="text" name="nombreCliente"  required placeholder="Ingrese los Nombres">
    </div>
     <label>Apellido *</label>
    <div>
      <input value="" class="controls" type="text" name="apellidoCliente"  required placeholder="Ingrese los Apellidos">
    </div>
     <label>Email *</label>
    <div>
      <input value="" class="controls " type="email" name="emailCliente"  required placeholder="Ingrese el Email">
    </div>
     <label>Telefono *</label>
    <div>
      <input value="" class="controls" type="text" name="telefonoCliente"  required placeholder="Ingrese el Telefono">
    </div>
     <label>Direccion *</label>
    <div>
      <input value="" class="controls" type="text" name="direccionCliente"  required placeholder="Ingrese la Direccion">
    </div>
