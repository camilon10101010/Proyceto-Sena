  ...
  <section class="form-register">
         <form action="../../ControllerUsuario" class="form" method="POST">
            ...
            <h4>Estas editando</h4>
                ...
                <label>Correo *</label>
                <div>
                    <input value="<%out.println(consultaUsuario.get(0).getCorreoUsuario()); %>" class="controls" type="text" name="correoUsuario"  required placeholder="Email del Usuario" readonly >
                </div>
