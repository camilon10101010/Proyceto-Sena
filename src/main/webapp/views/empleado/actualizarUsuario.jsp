  ...
  <section class="form-register">
         <form action="../../ControllerUsuario" class="form" method="POST">
            ...
            <h4>Estas editando</h4>
                <div>
                  <input value="<%out.println(consultaUsuario.get(0).getIdUsuario()); %>" class="controls" type="text" name="idUsuario"  readonly="#">
                </div>
                <div>
             ...
             <button name="btnAccion" type="submit" class="botons"  value="Actualizar">Editar Usuario</button>
         </form>   
  </section>
</header>
